...
echo ""
echo "When you see 'Connecting....____', please press/hold the 'BOOT' button on the ESP32 board. You can release the button after 3-5 seconds (until you see 'Erasing flash...')."
echo ""
echo "Got it?"
echo "[Press any key to continue]"
read -s -n 1
...
echo ""
echo "Again, when you see 'Connecting....____', please press/hold the 'BOOT' button on the ESP32 board. Like last time, you can release the button after 3-5 seconds (until you see 'Writing flash...')."
echo ""
echo "Sounds good?"
echo "[Press any key to continue]"
read -s -n 1
...
echo ""
echo "Please un-tether/disconnect your ESP32/Hadabot Turtle from the micro-USB cable connected to your computer."
echo ""
